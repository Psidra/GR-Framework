...
public:
	...
	virtual void UpdateBoss(Vector3& _destination, Vector3& _shootpos, Vector3& _enemydir,
							double _speed, int& _weaponIndex, float _health,
							double dt = 0.0333f);
	// ^ is a pretty crowded function tbh
